...
**2026-07 時点**では **Claude Opus 5** が最も良く、次いで **Claude Opus 4.8（high）**、
**OpenAI Codex 5.5**、**Gemini 3.5 Flash**；Claude 5 ファミリーの残り（**Fable 5** を含む）や
**Mistral AI** / **Sakana AI** は EADOS ではまだベンチマークしていません。*（モデルの順位は入れ替わりが速いため、
恒久的な主張ではなく日付きのスナップショットとして扱ってください。）*
...
**2026-07 時点**では **Claude Opus 5** が最良で、次いで Opus 4.8（high）、Codex 5.5、Gemini 3.5 Flash。
