...
[![Release](https://img.shields.io/badge/release-v2.10.0-blue.svg)](https://github.com/danielPoloWork/pgs-eados/releases)
...
**2026-07 時点**では **Claude Opus 4.8（high）** が最も良く、次いで **OpenAI Codex 5.5** と
**Gemini 3.5 Flash**；Claude 5 ファミリーの残り（**Fable 5** を含む）や **Mistral AI** /
**Sakana AI** は EADOS ではまだベンチマークしていません。*（モデルの順位は入れ替わりが速いため、
...
**2026-07 時点**では **Claude Opus 4.8（high）** が最良で、次いで Codex 5.5 と Gemini 3.5 Flash。
