...
|---|---|---|---|---|
| 1 | **architect** — `enterprise-architect` | Decide the architecture / author the ADR | `flag:decision-heavy`, `label:adr` | **frontier-reasoning / high** → Opus 5 |
...
route ("architect sub-task → frontier-reasoning / high → Opus 5 (advisory — this host has no
